 ...
 *   - On 404 error: `{ success: false, message: "Contact not found in Brevo.", error }`
 *   - On other errors: `{ success: false, message: "Error checking existing contact in Brevo.", error }`
 *
