...
const errorMessages: Record<string, ErrorMessages> = {
  ...
  occasion: {
    ...
    incorrectLength:
      'Please enter an occasion description that is between 2 and 300 characters. If no occasion, please enter "None".',
  },
  howFound: {
    incorrectChars: "Please remove uncommon special characters.",
    incorrectLength:
      "Please describe how you found us in between 2 and 300 characters.",
  },
  tanHistory: {
    incorrectChars: "Please remove uncommon special characters.",
    incorrectLength:
      "Please describe your spray tan history in between 2 and 300 characters.",
  },
  desiredResults: {
    incorrectChars: "Please remove uncommon special characters.",
    incorrectLength:
      "Please describe your desired results in between 2 and 300 characters.",
  },
  questionsConcerns: {
    incorrectChars: "Please remove uncommon special characters.",
    incorrectLength:
...
const createTestResults = (
  ...
  if (errorMessages.underage || errorMessages.invalidYear) {
    ...
    testResults.oldEnough = {
      result: oldEnough,
      errorMessage:
        errorMessages.underage ||
        "You must be at least 10 years old to book a spray tan.",
    };
...
export const handleQuestionsConcernsValidation = (
  ...
  const regEx = /^[a-zA-Z0-9.,'"?:()_@#!&$\-\/ \n\r]+$/;
  const results = createTestResults(
    questionsConcernsVal,
    regEx,
    0,
    300,
    errorMessages.questionsConcerns
  );
  const errors = createErrorMessagesArray(results);
