...
const InquiryForm: FC<ContactProps> = ({ slice }) => {
  ...
  const debouncedPhoneNumberValidation = useDebouncedCallback(
    handlePhoneNumberValidation,
    debounceDelay
  );
  ...
  const debouncedBirthdayValidation = useDebouncedCallback(
    handleBirthdayValidation,
    debounceDelay
  );
  ...
  const debouncedInstagramValidation = useDebouncedCallback(
    handleInstagramValidation,
    debounceDelay
  );
  ...
  const debouncedOccasionValidation = useDebouncedCallback(
    handleOccasionValidation,
    debounceDelay
  );
  ...
  const debouncedHowFoundValidation = useDebouncedCallback(
    handleHowFoundValidation,
    debounceDelay
  );
  const handleHowFoundChange = ({
    target,
  }: {
    target: HTMLTextAreaElement;
  }) => {
  ...
  const debouncedTanHistoryValidation = useDebouncedCallback(
    handleTanHistoryValidation,
    debounceDelay
  );
  const handleTanHistoryChange = ({
    target,
  }: {
    target: HTMLTextAreaElement;
  }) => {
  ...
  const debouncedDesiredResultsValidation = useDebouncedCallback(
    handleDesiredResultsValidation,
    debounceDelay
  );
  const handleDesiredResultsChange = ({
    target,
  }: {
    target: HTMLTextAreaElement;
  }) => {
  ...
  const debouncedQuestionsConcernsValidation = useDebouncedCallback(
    handleQuestionsConcernsValidation,
    debounceDelay
  );
  const handleQuestionsConcernsChange = ({
    target,
  }: {
    target: HTMLTextAreaElement;
  }) => {
  ...
  return (
    <form
      action={formAction}
      className={`${moduleStyles.inquiryForm}`}
    ...
    >
      <div className={moduleStyles.fieldContainer}>
        ...
        <div
          id="name-error"
          className={moduleStyles.errorContainer}
          aria-live="polite"
          aria-atomic
        >
      ...
      <div className={moduleStyles.fieldContainer}>
        <label htmlFor="phone-number-field">
          {slice.primary.phone_number_prompt + "*"}
        </label>
        <input
          type="tel"
          name="phoneNumber"
      ...
      <div className={moduleStyles.fieldContainer}>
        <label htmlFor="instagram-field">
          {slice.primary.instagram_prompt + "*"}
        </label>
        <input
          type="text"
          name="instagram"
      ...
      <div className={moduleStyles.fieldContainer}>
        <label htmlFor="occasion-field">
          {slice.primary.occasion_prompt + "*"}
        </label>
        <textarea
          name="occasion"
          id="occasion-field"
      ...
      <div className={moduleStyles.fieldContainer}>
        <label htmlFor="how-found-field">
          {slice.primary.how_you_found_us_prompt + "*"}
        </label>
        <textarea
          name="howFound"
          id="how-found-field"
      ...
      <div className={moduleStyles.fieldContainer}>
        <label htmlFor="tan-history-field">
          {slice.primary.tan_history_prompt + "*"}
        </label>
        <textarea
          name="tanHistory"
      ...
      <div className={moduleStyles.fieldContainer}>
        <label htmlFor="desired-results-field">
          {slice.primary.desired_results_prompt + "*"}
        </label>
        <textarea
          name="desiredResults"
      ...
      <div className={moduleStyles.fieldContainer}>
        <label htmlFor="questions-concerns-field">
          {slice.primary.questions_and_concerns_prompt}
        </label>
        <textarea
