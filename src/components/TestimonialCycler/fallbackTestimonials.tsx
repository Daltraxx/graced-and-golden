...
const fallbackTestimonials: JSX.Element[] = [
  <p key="fallback-testimonial-1">
    &ldquo;Grace is absolutely amazing. By far, the only person I trust with my spray
    ...
    tan in San Diego Grace is your girl. Highly highly recommend Grace!&rdquo;
  </p>,
  <p key="fallback-testimonial-2">
    &ldquo;I&rsquo;ve been going to Grace for my tans for about a year now and every single
  ...
  <p key="fallback-testimonial-3">
    &ldquo;Grace is amazing! Her tan stayed on for such a long time and looked great!
    ...
    again for my wedding and big events!&rdquo;
  </p>,
];
