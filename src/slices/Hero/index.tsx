  ...
  return (
    <Bounded data-slice-type={slice.slice_type} data-slice-variation={slice.variation} className={styles.backgroundCream300}>
      <div className="grid grid-cols-1 md:grid-cols-2 place-items-center w-10/12 m-auto">
        <PrismicNextImage field={slice.primary.image} width={3259} height={4888} className={`${styles.heroImage} mx-12`}/>
        <div className="text-center place-items-center">
          <PrismicRichText field={slice.primary.heading} components={components}/>
          <Button field={slice.primary.button} className={`${styles.buttonBrown800} my-4`}/>
        </div>
      </div>
    </Bounded>
  );
